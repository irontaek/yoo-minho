<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/banner-ko-dark.svg">
  <img alt="유민호 — 사람들이 재지 않고 논쟁만 하는 것들을 재는 작은 도구를 만듭니다. fixearly 로 채점한 오픈소스 74곳: S 16, A 21, B 16, C 14, D 6, E 1." src="assets/banner-ko-light.svg" width="100%">
</picture>
...
**나중에 이 코드를 고칠 때 드는 비용**을 재는 JS/TS 분석기입니다. 스타일도, 커버리지도 아닙니다.
100% 로컬, 업로드 없음, 설정 없음:
...
## 🧰 [@m1kapp](https://github.com/m1kapp) — 작업실
...
<sub>배너는 장식이 아니라 fixearly 코퍼스의 실제 등급 분포입니다.
<a href="tools/make-banner.py"><code>tools/make-banner.py</code></a> 가 다시 만들고,
▲ 는 fixearly 가 자기 자신에게 매긴 점수입니다.</sub>
